  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subscribe}>
        기록을 바탕으로{" "}
        <Text style={{ color: '#7BF179' }}>예상 티어</Text>
        를 계산해드려요
      </Text>

      <FontAwesome5 name="running" size={28} color="white" style={[styles.run, { marginTop: 70 }]} />
      ...
      <FontAwesome5 name="clock" size={28} color="white" style={styles.run} />
      <TextInput 

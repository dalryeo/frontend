...
const withIosRunning = (config) => {
    config = (0, config_plugins_1.withInfoPlist)(config, (infoPlistConfiguration) => {
        // 권한 메시지 설정
    ...
    // 2. Entitlements 설정
    config = (0, config_plugins_1.withEntitlementsPlist)(config, (entitlementsConfiguration) => {
        entitlementsConfiguration.modResults['com.apple.developer.healthkit'] =
            true;
        entitlementsConfiguration.modResults['com.apple.developer.healthkit.access'] = [];
